...
support_vehicles = [
	...
	[Respawn_truck_typename,15,150,5,0],
	["Land_RepairDepot_01_civ_F",10,300,0,0],
	["Land_MedicalTent_01_MTP_closed_F",5,150,0,0],
	[repair_sling_typename,10,300,0,0],
	[fuel_sling_typename,0,150,60,0],
	[ammo_sling_typename,0,600,0,0],
	[medic_sling_typename,10,150,0,0],
	[ammo_truck_typename,5,600,10,0],
	[repair_truck_typename,10,300,10,0],
	[fuel_truck_typename,5,150,70,0],
	[FOB_box_outpost,25,500,20,0],
	[FOB_box_typename,50,1500,50,0],
	[FOB_truck_typename,50,1500,50,0],
	[fireworks_typename,0,500,0,0],
